...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let API_KEY:String = "AIzaSyDD_aQoWJqYCLTy8ePMyEz8m1_b2l5nNcQ"
...
//        APIControlManager.sharedInstance.getNotificationCount()
//        APIControlManager.sharedInstance.getUnreadMessagesNumber()
    }
