...
//  Taallam
//
//  Created by Eng. Eman Rezk on 5/8/17.
...
open class TextViewWithPlaceHolder: UITextView{
    ...
    @IBInspectable open var placeholderColor: UIColor = TextViewWithPlaceHolder.Constants.defaultiOSPlaceholderColor {
        didSet {
    ...
    fileprivate func commonInit() {
        ...
        placeholderLabel.font = font
        placeholderLabel.textColor = placeholderColor
        placeholderLabel.textAlignment = .right//textAlignment
        placeholderLabel.text = placeholder
